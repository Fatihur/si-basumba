...
@section('title', 'Jenis LITMAS')

@section('content')
<div class="page-header">
    <div>
        <h1 class="page-title">Jenis LITMAS</h1>
        <p class="page-subtitle">Kelola data jenis penelitian kemasyarakatan</p>
    </div>
</div>
...
<div class="row">
    <div class="col-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.jenis-litmas.store') }}" method="POST">
                    @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    <form action="{{ route('admin.jenis-litmas.destroy', $item) }}" method="POST" onsubmit="return confirm('Yakin?')">@csrf @method('DELETE')<button type="submit" class="btn-icon" style="width: 28px; height: 28px; color: #ef4444;"><i class="bi bi-trash"></i></button></form>
                                </div>
                            </td>
                        </tr>
                        @empty
...
<script>
function editItem(id, nama, isActive) { document.getElementById('editForm').action = '{{ url("admin/jenis-litmas") }}/' + id; document.getElementById('editNama').value = nama; document.getElementById('editStatus').value = isActive ? '1' : '0'; document.getElementById('editModal').style.display = 'flex'; }
